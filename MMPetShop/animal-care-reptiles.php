...
<html lang="en">
<head>
	<title>M&M - Animal Care: Reptiles</title>
	<meta charset="utf-8">
		...
		<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ol class="breadcrumb">
							...
							<li class="active">Reptiles</li>						
						</ol>

						<div class="page-header">
							<h2>Proper Caring of Reptiles</h2>
						</div>
					</div>
					<img class="featuredImg" src="media/reptiles.jpg"/>
			...
			<div class="col-lg-2">
				<div class="list-group">
					...
					<a href="animal-care-dogs.php" class="list-group-item">
					...
					<a href="animal-care-reptiles.php" class="list-group-item active">
