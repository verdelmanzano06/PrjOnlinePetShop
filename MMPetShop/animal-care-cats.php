...
<html lang="en">
<head>
	<title>M&M - Animal Care: Cats</title>
	<meta charset="utf-8">
		...
		<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="page-header">
							<h2>Proper Caring of Cats</h2>
						</div>
					</div>
					<img class="featuredImg" src="media/cats.jpg"/>
			...
			<div class="col-lg-2">
				<div class="list-group">
					...
					<a href="animal-care-cats.php" class="list-group-item active">
